...
import Modal from '../common/Modal';
import { teacherImages } from '../../data/mockTeachers';  // <-- import teacherImages
        ...
        <div className="flex flex-col md:flex-row md:items-start gap-6">
          <div className="md:w-1/3">
            <div className="bg-gradient-to-br from-blue-500 to-purple-500 rounded-xl p-6 text-center text-white">
              <div className="h-32 w-32 mx-auto rounded-full border-4 border-white overflow-hidden mb-4">
                <img 
                  src={teacherImages[teacher.id] || `https://ui-avatars.com/api/?name=${encodeURIComponent(teacher.name)}&background=4F46E5&color=fff&size=128`} 
                  alt={teacher.name}
                  className="h-full w-full object-cover"
                />
              </div>
